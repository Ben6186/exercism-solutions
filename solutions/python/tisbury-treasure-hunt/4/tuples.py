...
def clean_up(combined_record_group):
    ...
    """
    report = []
    for name, unused_coordinate, location, coordinate_2, color in combined_record_group:
        clean = (name, location, coordinate_2, color)

        report.append(str(clean))
    return "\n".join(report) + "\n"    
